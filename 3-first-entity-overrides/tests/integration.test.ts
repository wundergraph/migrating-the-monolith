...
describe('3-first-entity-overrides integration tests', () => {
  ...
  test('that operations return the correct data', async () => {
    ...
    expect(userJson.extensions.trace.fetches.children).toHaveLength(2);
    expect(userJson.extensions.trace.fetches.children[0].fetch.source_name).toBe('monolith');
    expect(userJson.extensions.trace.fetches.children[1].fetch.source_name).toBe('users');
    ...
    expect(usersJson.extensions.trace.fetches.children).toHaveLength(2);
    expect(usersJson.extensions.trace.fetches.children[0].fetch.source_name).toBe('monolith');
    expect(usersJson.extensions.trace.fetches.children[1].children).toHaveLength(3);
    expect(usersJson.extensions.trace.fetches.children[1].children[0].fetch.source_name).toBe('products');
    expect(usersJson.extensions.trace.fetches.children[1].children[1].fetch.source_name).toBe('users');
    expect(usersJson.extensions.trace.fetches.children[1].children[2].fetch.source_name).toBe('users');
    ...
    expect(productJson.extensions.trace.fetches.children).toHaveLength(2);
    expect(productJson.extensions.trace.fetches.children[0].fetch.source_name).toBe('monolith');
    expect(productJson.extensions.trace.fetches.children[1].fetch.source_name).toBe('products');
    ...
    expect(productsJson.extensions.trace.fetches.children[1].fetch.source_name).toBe('products');
    ...
    expect(basketJson.extensions.trace.fetches.children[1].children).toHaveLength(2);
    expect(basketJson.extensions.trace.fetches.children[1].children[0].fetch.source_name).toBe('products');
    expect(basketJson.extensions.trace.fetches.children[1].children[1].fetch.source_name).toBe('users');
