...
describe('4-mutation-overrides integration tests', () => {
  ...
  test('that operations return the correct data', async () => {
    ...
    expect(usersJson.extensions.trace.fetches.children[1].children).toHaveLength(2);
    ...
    expect(productsJson.extensions.trace.fetches.children[1].children).toHaveLength(2);
    expect(productsJson.extensions.trace.fetches.children[1].children[0].fetch.source_name).toBe('products');
    expect(productsJson.extensions.trace.fetches.children[1].children[1].fetch.source_name).toBe('reviews');
